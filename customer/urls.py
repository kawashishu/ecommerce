...
from customer.views import login, password
...
urlpatterns = [
    ...
    path('dashboard-edit-profile/',
         login.EditProfileView.as_view(), name='dash-edit-profile'),


    # password views
    path('forgot_password/', password.forgotPassword, name='forgot_password'),
    path('reset_password_validate/<uidb64>/<token>',
         password.reset_password_validate, name='reset_password_validate'),
