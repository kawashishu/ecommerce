...
from .views import detail, category, cart, \
    currency, search, order, coupon, notification


urlpatterns = [
    path('',
         search.StoreView.as_view(), name='shop'),
    path('filter/',
         search.SearchFilterView.as_view(), name='filter'),
    ...
    path('cart/list/',
         cart.CartListView.as_view(), name='cart-list'),
    path('cart/',
         cart.CartView.as_view(), name='cart'),
    path('btn/', cart.CartCalculator.as_view(), name='btn'),

    path('category/<int:pk>',
         category.CategoryView.as_view(), name='categories'),
    ...
    # new ui
    path('wish-list/',
         cart.WishListView.as_view(), name='wish-list'),
    path('remove-wish-list/',
         cart.RemoveWishListView.as_view(), name='remove-wishlist'),

    # seen notifications
    path('seen-notifications/<int:pk>/',
         notification.seen_notifications, name='seen-notifications'),
]
